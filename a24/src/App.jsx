...
export const ACTIONS = {
  ...
  CLEAR: 'clear',
  EVALUATE: 'evaluate',
  DELETE_DIGIT: 'delete-digit', // Action type for deleting the last digit
};
...
function reducer(state, { type, payload }) {
  switch (type) {
    ...
    case ACTIONS.DELETE_DIGIT:
      ...
      // If currentOperand has only one digit, set it to null
...
function evaluate({ currentOperand, previousOperand, operation }) {
  ...
  if (isNaN(prev) || isNaN(current)) return 'Error'; // Handle invalid input
